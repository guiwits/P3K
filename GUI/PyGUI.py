#!/usr/bin/env python
# -*- coding: iso-8859-1 -*-
# generated by wxGlade 0.6.3 on Thu Feb 26 11:06:38 2009
...
class MyFrame1(wx.Frame):
	...
	self.Bind(wx.EVT_TIMER, self.OnTimer2, self.timer2)
        ...
        wxglade_tmp_menu.Append(wx.NewId(), "&Open", "Open a configuration file", wx.ITEM_NORMAL)
        wxglade_tmp_menu.Append(wx.NewId(), "&Save", "Save a configuration file", wx.ITEM_NORMAL)
        wxglade_tmp_menu.AppendSeparator()
        wxglade_tmp_menu.Append(wx.NewId(), "&Quit\tCtrl+Q", "Quit Palomar AO Control", wx.ITEM_NORMAL)
        self.frame_2_menubar.Append(wxglade_tmp_menu, "&File")
        wxglade_tmp_menu = wx.Menu()
        self.frame_2_menubar.Append(wxglade_tmp_menu, "&Edit")
	self.frame_2_menubar.Append(wxglade_tmp_menu, "&Plot")
        wxglade_tmp_menu = wx.Menu()
	plotMenu = wx.Menu()
	self.plotTTM = wx.MenuItem (wxglade_tmp_menu, wx.NewId(), "TTM Pos", "Plot TTM Positions", wx.ITEM_NORMAL)
	plotMenu.AppendItem(self.plotTTM)
        self.About = wx.MenuItem(wxglade_tmp_menu, wx.NewId(), "About", "About Palomar 3000 Control Software", wx.ITEM_NORMAL)
        ...
        self.label_11 = wx.StaticText(self, -1, "Palomar 3000")
        ...
        self.button_2 = wx.ToggleButton(self, -1, "LODM", pos=(-1, -1), size=(80, 35))
        self.button_3 = wx.ToggleButton(self, -1, "HODM", pos=(-1, -1), size=(80, 35))
        ...
        self.label_8 = wx.StaticText(self, -1, "Parameters", style=wx.ALIGN_CENTRE)
	...
	self.Bind (wx.EVT_TOGGLEBUTTON, self.OnHODM, self.button_3)
        ...
        self.Bind(wx.EVT_CHECKBOX, self.GoParameters, self.checkbox_6)
...
# end wxGlade
	...
	if self.checkbox_1.IsChecked() == True:
		...
		self.acqcam = AcqCam.AcqCam (self, 120, 'Palomar 3000 Acquisition Camera')
	...
	if self.checkbox_2.IsChecked() == True:
		...
		self.wfs = WFSCamera.WFSCamera (self, 125, 'WFS Camera')
		self.wfs.Show (True)
	else:
		self.CloseWfsCam ()
	...
	if self.checkbox_5.IsChecked() == True:
		...
		self.motors = Motors.Motors (self, 140, 'Palomar 3000 Motion Control')
    ...
    def GoParameters(self, event): # wxGlade: MyFrame1.<event_handler>
	if self.checkbox_6.IsChecked() == True:
        	print "Starting Parameters..."
		self.param = Parameters.Parameters (self, 145, 'Palomar 3000 Parameter Settings')
